package com.poja.sary_std22106.unit;
...
import com.poja.sary_std22106.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja.sary_std22106.endpoint.event.gen.UuidCreated", payload);
